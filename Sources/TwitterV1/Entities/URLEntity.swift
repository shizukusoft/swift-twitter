...
public struct URLEntity: Entity {
    ...
    public let expandedURLString: String?
}
...
extension URLEntity: Decodable {
    enum CodingKeys: String, CodingKey {
        ...
        case expandedURLString = "expanded_url"
    }
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.expandedURLString = try container.decodeIfPresent(String.self, forKey: .expandedURLString)
    }
}
